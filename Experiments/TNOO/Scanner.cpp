...
void Scanner::Init() {
	...
	keywords.set(L"MODULE", 6);
	keywords.set(L"BEGIN", 8);
	keywords.set(L"END", 9);
	keywords.set(L"IMPORT", 11);
	keywords.set(L"CONST", 14);
	keywords.set(L"TYPE", 15);
	keywords.set(L"VAR", 16);
	keywords.set(L"PROCEDURE", 19);
	keywords.set(L"ARRAY", 23);
	keywords.set(L"OF", 24);
	keywords.set(L"RECORD", 25);
	keywords.set(L"POINTER", 26);
	keywords.set(L"TO", 27);
	keywords.set(L"IF", 28);
	keywords.set(L"THEN", 29);
	keywords.set(L"ELSIF", 30);
	keywords.set(L"ELSE", 31);
	keywords.set(L"CASE", 32);
	keywords.set(L"WHILE", 34);
	keywords.set(L"DO", 35);
	keywords.set(L"REPEAT", 36);
	keywords.set(L"UNTIL", 37);
	keywords.set(L"FOR", 38);
	keywords.set(L"BY", 39);
	keywords.set(L"LOOP", 40);
	keywords.set(L"WITH", 41);
	keywords.set(L"EXIT", 42);
	keywords.set(L"RETURN", 43);
	keywords.set(L"NIL", 47);
	keywords.set(L"IN", 56);
	keywords.set(L"IS", 57);
	keywords.set(L"OR", 58);
	keywords.set(L"DIV", 61);
	keywords.set(L"MOD", 62);
...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 3:
			...
			else if ((ch >= L'D' && ch <= L'E')) {AddCh(); goto case_4;}
			else {t->kind = 3; break;}
		case 4:
			case_4:
		...
		case 8:
			case_8:
			if (ch <= L'!' || (ch >= L'#' && ch <= 65535)) {AddCh(); goto case_8;}
			else if (ch == L'"') {AddCh(); goto case_10;}
			else {goto case_0;}
		case 9:
			case_9:
			if (ch <= L'&' || (ch >= L'(' && ch <= 65535)) {AddCh(); goto case_9;}
		...
		case 11:
			...
			else if ((ch >= L'A' && ch <= L'F')) {AddCh(); goto case_12;}
			else if (ch == L'H') {AddCh(); goto case_2;}
			else if (ch == L'.') {AddCh(); goto case_3;}
			else if (ch == L'X') {AddCh(); goto case_7;}
			else {t->kind = 2; break;}
		case 12:
			case_12:
			if ((ch >= L'0' && ch <= L'9') || (ch >= L'A' && ch <= L'F')) {AddCh(); goto case_12;}
			else if (ch == L'H') {AddCh(); goto case_2;}
			else if (ch == L'X') {AddCh(); goto case_7;}
			else {goto case_0;}
		case 13:
